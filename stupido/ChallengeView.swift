...
struct ChallengeView_Previews: PreviewProvider {
  static var previews: some View {
    NavigationStack{
      ChallengeView(challengeStore: Store(initialState:ChallengeFeature.State( challenges:SampleData.challenges,                                   scoreDatum: SampleData.scoreDatum, outcomes: SampleData.outcomes,questionNumber:0 ))
                    {  ChallengeFeature( )  } )
    }
